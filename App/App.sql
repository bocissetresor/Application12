...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 29 déc. 2022 à 01:31
...
(1, 'pbkdf2_sha256$390000$lM7uWRorGH3jC7lP5huGZB$pJbGXqwldcuhJWYFjGs1M3196J22S0cpkU6v2z+cs68=', '2022-12-29 00:28:56.134157', 1, 'test', '', '', 'test@gmail.com', 1, 1, '2022-12-28 23:58:01.534836'),
(2, 'pbkdf2_sha256$390000$XBiAtLOHPUtH42c84Qe0FV$AYKlSSLk5f4VZuewmau65g/WlZLI0HL1TFimM/nUkXY=', NULL, 0, 'test2', 'test2', 'test2', 'test2@gmail.com', 0, 1, '2022-12-29 00:15:24.711988');
...
(1, 'contenttypes', '0001_initial', '2022-12-28 23:56:47.462638'),
(2, 'auth', '0001_initial', '2022-12-28 23:57:03.250574'),
(3, 'admin', '0001_initial', '2022-12-28 23:57:05.944433'),
(4, 'admin', '0002_logentry_remove_auto_add', '2022-12-28 23:57:06.005436'),
(5, 'admin', '0003_logentry_add_action_flag_choices', '2022-12-28 23:57:06.069427'),
(6, 'contenttypes', '0002_remove_content_type_name', '2022-12-28 23:57:07.103333'),
(7, 'auth', '0002_alter_permission_name_max_length', '2022-12-28 23:57:08.485653'),
(8, 'auth', '0003_alter_user_email_max_length', '2022-12-28 23:57:08.700990'),
(9, 'auth', '0004_alter_user_username_opts', '2022-12-28 23:57:08.784865'),
(10, 'auth', '0005_alter_user_last_login_null', '2022-12-28 23:57:10.091808'),
(11, 'auth', '0006_require_contenttypes_0002', '2022-12-28 23:57:10.244722'),
(12, 'auth', '0007_alter_validators_add_error_messages', '2022-12-28 23:57:10.325292'),
(13, 'auth', '0008_alter_user_username_max_length', '2022-12-28 23:57:10.455480'),
(14, 'auth', '0009_alter_user_last_name_max_length', '2022-12-28 23:57:10.613862'),
(15, 'auth', '0010_alter_group_name_max_length', '2022-12-28 23:57:10.779356'),
(16, 'auth', '0011_update_proxy_permissions', '2022-12-28 23:57:10.866352'),
(17, 'auth', '0012_alter_user_first_name_max_length', '2022-12-28 23:57:11.028350'),
(18, 'sessions', '0001_initial', '2022-12-28 23:57:11.705411');
...
--
CREATE DATABASE IF NOT EXISTS `joomla` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `joomla`;

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_action_logs`
--

CREATE TABLE `ue8vn_action_logs` (
...
--
-- Déchargement des données de la table `ue8vn_action_logs`
--

INSERT INTO `ue8vn_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":458,\"username\":\"bocissetresor\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=458\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2022-11-25 01:28:06', 'com_users', 458, 0, 'COM_ACTIONLOGS_DISABLED'),
(2, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_UPDATED', '{\"action\":\"update\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MODULE\",\"id\":17,\"title\":\"Breadcrumbs\",\"extension_name\":\"Breadcrumbs\",\"itemlink\":\"index.php?option=com_modules&task=module.edit&id=17\",\"userid\":458,\"username\":\"bocissetresor\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=458\"}', '2022-11-25 01:30:55', 'com_modules.module', 458, 17, 'COM_ACTIONLOGS_DISABLED'),
(3, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_UPDATED', '{\"action\":\"update\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MODULE\",\"id\":16,\"title\":\"Login Form\",\"extension_name\":\"Login Form\",\"itemlink\":\"index.php?option=com_modules&task=module.edit&id=16\",\"userid\":458,\"username\":\"bocissetresor\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=458\"}', '2022-11-25 01:32:03', 'com_modules.module', 458, 16, 'COM_ACTIONLOGS_DISABLED'),
(4, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_OUT', '{\"action\":\"logout\",\"id\":458,\"userid\":458,\"username\":\"bocissetresor\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=458\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE\"}', '2022-11-25 01:33:53', 'com_users', 458, 458, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_action_logs_extensions`
--

CREATE TABLE `ue8vn_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `ue8vn_action_logs_extensions`
--

INSERT INTO `ue8vn_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Structure de la table `ue8vn_action_logs_users`
--

CREATE TABLE `ue8vn_action_logs_users` (
...
--
-- Structure de la table `ue8vn_action_log_config`
--

CREATE TABLE `ue8vn_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Déchargement des données de la table `ue8vn_action_log_config`
--

INSERT INTO `ue8vn_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Structure de la table `ue8vn_assets`
--

CREATE TABLE `ue8vn_assets` (
...
--
-- Déchargement des données de la table `ue8vn_assets`
--

INSERT INTO `ue8vn_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Structure de la table `ue8vn_associations`
--

CREATE TABLE `ue8vn_associations` (
...
--
-- Structure de la table `ue8vn_banners`
--

CREATE TABLE `ue8vn_banners` (
  `id` int(11) NOT NULL,
...
--
-- Structure de la table `ue8vn_banner_clients`
--

CREATE TABLE `ue8vn_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Structure de la table `ue8vn_banner_tracks`
--

CREATE TABLE `ue8vn_banner_tracks` (
...
--
-- Structure de la table `ue8vn_categories`
--

CREATE TABLE `ue8vn_categories` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `ue8vn_categories`
--

INSERT INTO `ue8vn_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, NULL, NULL, 1, '{}', '', '', '{}', 458, '2022-11-25 01:24:05', 458, '2022-11-25 01:24:05', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\",\"workflow_id\":\"use_default\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 458, '2022-11-25 01:24:05', 458, '2022-11-25 01:24:05', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 458, '2022-11-25 01:24:05', 458, '2022-11-25 01:24:05', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 458, '2022-11-25 01:24:05', 458, '2022-11-25 01:24:05', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 458, '2022-11-25 01:24:05', 458, '2022-11-25 01:24:05', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 458, '2022-11-25 01:24:05', 458, '2022-11-25 01:24:05', 0, '*', 1);

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_contact_details`
--

CREATE TABLE `ue8vn_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Structure de la table `ue8vn_content`
--

CREATE TABLE `ue8vn_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Structure de la table `ue8vn_contentitem_tag_map`
--

CREATE TABLE `ue8vn_contentitem_tag_map` (
  `type_alias` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Structure de la table `ue8vn_content_frontpage`
--

CREATE TABLE `ue8vn_content_frontpage` (
...
--
-- Structure de la table `ue8vn_content_rating`
--

CREATE TABLE `ue8vn_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Structure de la table `ue8vn_content_types`
--

CREATE TABLE `ue8vn_content_types` (
...
--
-- Déchargement des données de la table `ue8vn_content_types`
--

INSERT INTO `ue8vn_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Structure de la table `ue8vn_extensions`
--

CREATE TABLE `ue8vn_extensions` (
...
--
-- Déchargement des données de la table `ue8vn_extensions`
--

INSERT INTO `ue8vn_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `changelogurl`, `folder`, `client_id`, `enabled`, `access`, `protected`, `locked`, `manifest_cache`, `params`, `custom_data`, `checked_out`, `checked_out_time`, `ordering`, `state`, `note`) VALUES
...
(186, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', NULL, 'system', 0, 1, 1, 0, 1, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"2015-05\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2015 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1669383232}', '', NULL, NULL, 23, 0, NULL),
...
(224, 0, 'files_joomla', 'file', 'joomla', NULL, '', 0, 1, 1, 1, 1, '{\"name\":\"files_joomla\",\"type\":\"file\",\"creationDate\":\"2022-11\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2019 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.2.5\",\"description\":\"FILES_JOOMLA_XML_DESCRIPTION\",\"group\":\"\"}', '', '', NULL, NULL, 0, 0, NULL),
(225, 0, 'English (en-GB) Language Pack', 'package', 'pkg_en-GB', NULL, '', 0, 1, 1, 1, 1, '{\"name\":\"English (en-GB) Language Pack\",\"type\":\"package\",\"creationDate\":\"2022-11\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2019 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.2.5.1\",\"description\":\"en-GB language pack\",\"group\":\"\",\"filename\":\"pkg_en-GB\"}', '', '', NULL, NULL, 0, 0, NULL),
(226, 225, 'English (en-GB)', 'language', 'en-GB', NULL, '', 0, 1, 1, 1, 1, '{\"name\":\"English (en-GB)\",\"type\":\"language\",\"creationDate\":\"2022-11\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2006 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.2.5\",\"description\":\"en-GB site language\",\"group\":\"\"}', '', '', NULL, NULL, 0, 0, NULL),
(227, 225, 'English (en-GB)', 'language', 'en-GB', NULL, '', 1, 1, 1, 1, 1, '{\"name\":\"English (en-GB)\",\"type\":\"language\",\"creationDate\":\"2022-11\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2005 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.2.5\",\"description\":\"en-GB administrator language\",\"group\":\"\"}', '', '', NULL, NULL, 0, 0, NULL),
(228, 225, 'English (en-GB)', 'language', 'en-GB', NULL, '', 3, 1, 1, 1, 1, '{\"name\":\"English (en-GB)\",\"type\":\"language\",\"creationDate\":\"2022-11\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2020 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.2.5\",\"description\":\"en-GB api language\",\"group\":\"\"}', '', '', NULL, NULL, 0, 0, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_fields`
--

CREATE TABLE `ue8vn_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `ue8vn_fields_categories`
--

CREATE TABLE `ue8vn_fields_categories` (
...
--
-- Structure de la table `ue8vn_fields_groups`
--

CREATE TABLE `ue8vn_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Structure de la table `ue8vn_fields_values`
--

CREATE TABLE `ue8vn_fields_values` (
...
--
-- Structure de la table `ue8vn_finder_filters`
--

CREATE TABLE `ue8vn_finder_filters` (
...
--
-- Structure de la table `ue8vn_finder_links`
--

CREATE TABLE `ue8vn_finder_links` (
...
--
-- Structure de la table `ue8vn_finder_links_terms`
--

CREATE TABLE `ue8vn_finder_links_terms` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `ue8vn_finder_logging`
--

CREATE TABLE `ue8vn_finder_logging` (
...
--
-- Structure de la table `ue8vn_finder_taxonomy`
--

CREATE TABLE `ue8vn_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Déchargement des données de la table `ue8vn_finder_taxonomy`
--

INSERT INTO `ue8vn_finder_taxonomy` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `state`, `access`, `language`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', 1, 1, '*');

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_finder_taxonomy_map`
--

CREATE TABLE `ue8vn_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `ue8vn_finder_terms`
--

CREATE TABLE `ue8vn_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `ue8vn_finder_terms_common`
--

CREATE TABLE `ue8vn_finder_terms_common` (
...
--
-- Déchargement des données de la table `ue8vn_finder_terms_common`
--

INSERT INTO `ue8vn_finder_terms_common` (`term`, `language`, `custom`) VALUES
('a', 'en', 0),
('about', 'en', 0),
('above', 'en', 0),
('after', 'en', 0),
...
--
-- Structure de la table `ue8vn_finder_tokens`
--

CREATE TABLE `ue8vn_finder_tokens` (
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
  `phrase` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Structure de la table `ue8vn_finder_tokens_aggregate`
--

CREATE TABLE `ue8vn_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Structure de la table `ue8vn_finder_types`
--

CREATE TABLE `ue8vn_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `ue8vn_history`
--

CREATE TABLE `ue8vn_history` (
...
--
-- Structure de la table `ue8vn_languages`
--

CREATE TABLE `ue8vn_languages` (
...
--
-- Déchargement des données de la table `ue8vn_languages`
--

INSERT INTO `ue8vn_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_mail_templates`
--

CREATE TABLE `ue8vn_mail_templates` (
...
--
-- Déchargement des données de la table `ue8vn_mail_templates`
--

INSERT INTO `ue8vn_mail_templates` (`template_id`, `extension`, `language`, `subject`, `body`, `htmlbody`, `attachments`, `params`) VALUES
...
--
-- Structure de la table `ue8vn_menu`
--

CREATE TABLE `ue8vn_menu` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `ue8vn_menu`
--

INSERT INTO `ue8vn_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`) VALUES
...
--
-- Structure de la table `ue8vn_menu_types`
--

CREATE TABLE `ue8vn_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Déchargement des données de la table `ue8vn_menu_types`
--

INSERT INTO `ue8vn_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_messages`
--

CREATE TABLE `ue8vn_messages` (
...
--
-- Structure de la table `ue8vn_messages_cfg`
--

CREATE TABLE `ue8vn_messages_cfg` (
...
--
-- Structure de la table `ue8vn_modules`
--

CREATE TABLE `ue8vn_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
...
--
-- Déchargement des données de la table `ue8vn_modules`
--

INSERT INTO `ue8vn_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(16, 50, 'Login Form', '', '', 1, 'footer', NULL, NULL, NULL, NULL, 1, 'mod_login', 1, 1, '{\"pretext\":\"\",\"posttext\":\"\",\"login\":\"\",\"logout\":\"\",\"customRegLinkMenu\":\"\",\"greeting\":1,\"name\":0,\"profilelink\":0,\"usetext\":0,\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"module_tag\":\"div\",\"bootstrap_size\":\"0\",\"header_tag\":\"h3\",\"header_class\":\"\",\"style\":\"0\"}', 0, '*'),
(17, 51, 'Breadcrumbs', 'Cli', '', 1, 'bottom-b', NULL, NULL, NULL, NULL, 1, 'mod_breadcrumbs', 1, 1, '{\"showHere\":1,\"showHome\":1,\"homeText\":\"\",\"showLast\":1,\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"cache\":0,\"cache_time\":0,\"cachemode\":\"itemid\",\"module_tag\":\"div\",\"bootstrap_size\":\"0\",\"header_tag\":\"h3\",\"header_class\":\"\",\"style\":\"0\"}', 0, '*'),
...
--
-- Structure de la table `ue8vn_modules_menu`
--

CREATE TABLE `ue8vn_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT 0,
  `menuid` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `ue8vn_modules_menu`
--

INSERT INTO `ue8vn_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Structure de la table `ue8vn_newsfeeds`
--

CREATE TABLE `ue8vn_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT 0,
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `ue8vn_overrider`
--

CREATE TABLE `ue8vn_overrider` (
...
--
-- Structure de la table `ue8vn_postinstall_messages`
--

CREATE TABLE `ue8vn_postinstall_messages` (
...
--
-- Déchargement des données de la table `ue8vn_postinstall_messages`
--

INSERT INTO `ue8vn_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Structure de la table `ue8vn_privacy_consents`
--

CREATE TABLE `ue8vn_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `state` int(11) NOT NULL DEFAULT 1,
  `created` datetime NOT NULL,
...
--
-- Structure de la table `ue8vn_privacy_requests`
--

CREATE TABLE `ue8vn_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `ue8vn_redirect_links`
--

CREATE TABLE `ue8vn_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `ue8vn_scheduler_tasks`
--

CREATE TABLE `ue8vn_scheduler_tasks` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Structure de la table `ue8vn_schemas`
--

CREATE TABLE `ue8vn_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `ue8vn_schemas`
--

INSERT INTO `ue8vn_schemas` (`extension_id`, `version_id`) VALUES
(224, '4.2.3-2022-09-07');

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_session`
--

CREATE TABLE `ue8vn_session` (
...
--
-- Déchargement des données de la table `ue8vn_session`
--

INSERT INTO `ue8vn_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x366435633435316b3169306f346274356f6b6970617374693036, NULL, 1, 1669383239, 'joomla|s:340:\"\";', 0, '');

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_tags`
--

CREATE TABLE `ue8vn_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Déchargement des données de la table `ue8vn_tags`
--

INSERT INTO `ue8vn_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, NULL, NULL, 1, '', '', '', '', 458, '2022-11-25 01:23:53', '', 458, '2022-11-25 01:23:53', '', '', 0, '*', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_template_overrides`
--

CREATE TABLE `ue8vn_template_overrides` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `ue8vn_template_styles`
--

CREATE TABLE `ue8vn_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
  `template` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `client_id` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Déchargement des données de la table `ue8vn_template_styles`
--

INSERT INTO `ue8vn_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `inheritable`, `parent`, `params`) VALUES
...
--
-- Structure de la table `ue8vn_ucm_base`
--

CREATE TABLE `ue8vn_ucm_base` (
...
--
-- Structure de la table `ue8vn_ucm_content`
--

CREATE TABLE `ue8vn_ucm_content` (
...
--
-- Structure de la table `ue8vn_updates`
--

CREATE TABLE `ue8vn_updates` (
...
--
-- Structure de la table `ue8vn_update_sites`
--

CREATE TABLE `ue8vn_update_sites` (
...
--
-- Déchargement des données de la table `ue8vn_update_sites`
--

INSERT INTO `ue8vn_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`, `checked_out`, `checked_out_time`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1669383238, '', NULL, NULL),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_4.xml', 1, 1669339545, '', NULL, NULL),
(3, 'Joomla! Update Component', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 0, '', NULL, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_update_sites_extensions`
--

CREATE TABLE `ue8vn_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT 0,
  `extension_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Déchargement des données de la table `ue8vn_update_sites_extensions`
--

INSERT INTO `ue8vn_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 224),
(2, 225),
(3, 24);
...
--
-- Structure de la table `ue8vn_usergroups`
--

CREATE TABLE `ue8vn_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Déchargement des données de la table `ue8vn_usergroups`
--

INSERT INTO `ue8vn_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Structure de la table `ue8vn_users`
--

CREATE TABLE `ue8vn_users` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `ue8vn_users`
--

INSERT INTO `ue8vn_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`, `authProvider`) VALUES
(458, 'Cissé Yaya Tresor', 'bocissetresor', 'bocissetresor@gmail.com', '$2y$10$GThc46xj6A/QuWOLnvM37ejarweAP11lAJqg38qw3GyHAcv.Hgjsa', 0, 1, '2022-11-25 01:25:40', '2022-11-25 01:33:53', '0', '', NULL, 0, '', '', 0, '');

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_user_keys`
--

CREATE TABLE `ue8vn_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `ue8vn_user_mfa`
--

CREATE TABLE `ue8vn_user_mfa` (
  `id` int(11) NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Structure de la table `ue8vn_user_notes`
--

CREATE TABLE `ue8vn_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `catid` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Structure de la table `ue8vn_user_profiles`
--

CREATE TABLE `ue8vn_user_profiles` (
  `user_id` int(11) NOT NULL,
...
--
-- Structure de la table `ue8vn_user_usergroup_map`
--

CREATE TABLE `ue8vn_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `ue8vn_user_usergroup_map`
--

INSERT INTO `ue8vn_user_usergroup_map` (`user_id`, `group_id`) VALUES
(458, 8);

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_viewlevels`
--

CREATE TABLE `ue8vn_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT 0,
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Déchargement des données de la table `ue8vn_viewlevels`
--

INSERT INTO `ue8vn_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Structure de la table `ue8vn_webauthn_credentials`
--

CREATE TABLE `ue8vn_webauthn_credentials` (
...
--
-- Structure de la table `ue8vn_workflows`
--

CREATE TABLE `ue8vn_workflows` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `ue8vn_workflows`
--

INSERT INTO `ue8vn_workflows` (`id`, `asset_id`, `published`, `title`, `description`, `extension`, `default`, `ordering`, `created`, `created_by`, `modified`, `modified_by`, `checked_out_time`, `checked_out`) VALUES
(1, 56, 1, 'COM_WORKFLOW_BASIC_WORKFLOW', '', 'com_content.article', 1, 1, '2022-11-25 01:24:01', 458, '2022-11-25 01:24:01', 458, NULL, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_workflow_associations`
--

CREATE TABLE `ue8vn_workflow_associations` (
...
--
-- Structure de la table `ue8vn_workflow_stages`
--

CREATE TABLE `ue8vn_workflow_stages` (
  `id` int(11) NOT NULL,
  `asset_id` int(11) DEFAULT 0,
  `ordering` int(11) NOT NULL DEFAULT 0,
...
--
-- Déchargement des données de la table `ue8vn_workflow_stages`
--

INSERT INTO `ue8vn_workflow_stages` (`id`, `asset_id`, `ordering`, `workflow_id`, `published`, `title`, `description`, `default`, `checked_out_time`, `checked_out`) VALUES
(1, 57, 1, 1, 1, 'COM_WORKFLOW_BASIC_STAGE', '', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `ue8vn_workflow_transitions`
--

CREATE TABLE `ue8vn_workflow_transitions` (
  `id` int(11) NOT NULL,
  `asset_id` int(11) DEFAULT 0,
  `ordering` int(11) NOT NULL DEFAULT 0,
  `workflow_id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `ue8vn_workflow_transitions`
--

INSERT INTO `ue8vn_workflow_transitions` (`id`, `asset_id`, `ordering`, `workflow_id`, `published`, `title`, `description`, `from_stage_id`, `to_stage_id`, `options`, `checked_out_time`, `checked_out`) VALUES
...
--
-- Index pour la table `ue8vn_action_logs`
--
ALTER TABLE `ue8vn_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `ue8vn_action_logs_extensions`
--
ALTER TABLE `ue8vn_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `ue8vn_action_logs_users`
--
ALTER TABLE `ue8vn_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Index pour la table `ue8vn_action_log_config`
--
ALTER TABLE `ue8vn_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `ue8vn_assets`
--
ALTER TABLE `ue8vn_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `ue8vn_associations`
--
ALTER TABLE `ue8vn_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Index pour la table `ue8vn_banners`
--
ALTER TABLE `ue8vn_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `ue8vn_banner_clients`
--
ALTER TABLE `ue8vn_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Index pour la table `ue8vn_banner_tracks`
--
ALTER TABLE `ue8vn_banner_tracks`
...
--
-- Index pour la table `ue8vn_categories`
--
ALTER TABLE `ue8vn_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `ue8vn_contact_details`
--
ALTER TABLE `ue8vn_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Index pour la table `ue8vn_content`
--
ALTER TABLE `ue8vn_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Index pour la table `ue8vn_contentitem_tag_map`
--
ALTER TABLE `ue8vn_contentitem_tag_map`
...
--
-- Index pour la table `ue8vn_content_frontpage`
--
ALTER TABLE `ue8vn_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Index pour la table `ue8vn_content_rating`
--
ALTER TABLE `ue8vn_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Index pour la table `ue8vn_content_types`
--
ALTER TABLE `ue8vn_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Index pour la table `ue8vn_extensions`
--
ALTER TABLE `ue8vn_extensions`
...
--
-- Index pour la table `ue8vn_fields`
--
ALTER TABLE `ue8vn_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Index pour la table `ue8vn_fields_categories`
--
ALTER TABLE `ue8vn_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Index pour la table `ue8vn_fields_groups`
--
ALTER TABLE `ue8vn_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Index pour la table `ue8vn_fields_values`
--
ALTER TABLE `ue8vn_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Index pour la table `ue8vn_finder_filters`
--
ALTER TABLE `ue8vn_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Index pour la table `ue8vn_finder_links`
--
ALTER TABLE `ue8vn_finder_links`
...
--
-- Index pour la table `ue8vn_finder_links_terms`
--
ALTER TABLE `ue8vn_finder_links_terms`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `ue8vn_finder_logging`
--
ALTER TABLE `ue8vn_finder_logging`
  ADD PRIMARY KEY (`md5sum`),
  ADD KEY `searchterm` (`searchterm`(191));

--
-- Index pour la table `ue8vn_finder_taxonomy`
--
ALTER TABLE `ue8vn_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_state` (`state`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_path` (`path`(100)),
...
--
-- Index pour la table `ue8vn_finder_taxonomy_map`
--
ALTER TABLE `ue8vn_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Index pour la table `ue8vn_finder_terms`
--
ALTER TABLE `ue8vn_finder_terms`
...
--
-- Index pour la table `ue8vn_finder_terms_common`
--
ALTER TABLE `ue8vn_finder_terms_common`
  ADD UNIQUE KEY `idx_term_language` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Index pour la table `ue8vn_finder_tokens`
--
ALTER TABLE `ue8vn_finder_tokens`
...
--
-- Index pour la table `ue8vn_finder_tokens_aggregate`
--
ALTER TABLE `ue8vn_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Index pour la table `ue8vn_finder_types`
--
ALTER TABLE `ue8vn_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Index pour la table `ue8vn_history`
--
ALTER TABLE `ue8vn_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Index pour la table `ue8vn_languages`
--
ALTER TABLE `ue8vn_languages`
...
--
-- Index pour la table `ue8vn_mail_templates`
--
ALTER TABLE `ue8vn_mail_templates`
  ADD PRIMARY KEY (`template_id`,`language`);

--
-- Index pour la table `ue8vn_menu`
--
ALTER TABLE `ue8vn_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `ue8vn_menu_types`
--
ALTER TABLE `ue8vn_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Index pour la table `ue8vn_messages`
--
ALTER TABLE `ue8vn_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Index pour la table `ue8vn_messages_cfg`
--
ALTER TABLE `ue8vn_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Index pour la table `ue8vn_modules`
--
ALTER TABLE `ue8vn_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `ue8vn_modules_menu`
--
ALTER TABLE `ue8vn_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Index pour la table `ue8vn_newsfeeds`
--
ALTER TABLE `ue8vn_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Index pour la table `ue8vn_overrider`
--
ALTER TABLE `ue8vn_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `ue8vn_postinstall_messages`
--
ALTER TABLE `ue8vn_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Index pour la table `ue8vn_privacy_consents`
--
ALTER TABLE `ue8vn_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Index pour la table `ue8vn_privacy_requests`
--
ALTER TABLE `ue8vn_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `ue8vn_redirect_links`
--
ALTER TABLE `ue8vn_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modified` (`modified_date`);

--
-- Index pour la table `ue8vn_scheduler_tasks`
--
ALTER TABLE `ue8vn_scheduler_tasks`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `ue8vn_schemas`
--
ALTER TABLE `ue8vn_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Index pour la table `ue8vn_session`
--
ALTER TABLE `ue8vn_session`
...
--
-- Index pour la table `ue8vn_tags`
--
ALTER TABLE `ue8vn_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `ue8vn_template_overrides`
--
ALTER TABLE `ue8vn_template_overrides`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_extension_id` (`extension_id`);

--
-- Index pour la table `ue8vn_template_styles`
--
ALTER TABLE `ue8vn_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
...
--
-- Index pour la table `ue8vn_ucm_base`
--
ALTER TABLE `ue8vn_ucm_base`
...
--
-- Index pour la table `ue8vn_ucm_content`
--
ALTER TABLE `ue8vn_ucm_content`
...
--
-- Index pour la table `ue8vn_updates`
--
ALTER TABLE `ue8vn_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Index pour la table `ue8vn_update_sites`
--
ALTER TABLE `ue8vn_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Index pour la table `ue8vn_update_sites_extensions`
--
ALTER TABLE `ue8vn_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Index pour la table `ue8vn_usergroups`
--
ALTER TABLE `ue8vn_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `ue8vn_users`
--
ALTER TABLE `ue8vn_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `ue8vn_user_keys`
--
ALTER TABLE `ue8vn_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Index pour la table `ue8vn_user_mfa`
--
ALTER TABLE `ue8vn_user_mfa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Index pour la table `ue8vn_user_notes`
--
ALTER TABLE `ue8vn_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Index pour la table `ue8vn_user_profiles`
--
ALTER TABLE `ue8vn_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Index pour la table `ue8vn_user_usergroup_map`
--
ALTER TABLE `ue8vn_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Index pour la table `ue8vn_viewlevels`
--
ALTER TABLE `ue8vn_viewlevels`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_assetgroup_title_lookup` (`title`);

--
-- Index pour la table `ue8vn_webauthn_credentials`
--
ALTER TABLE `ue8vn_webauthn_credentials`
  ADD PRIMARY KEY (`id`(100)),
  ADD KEY `user_id` (`user_id`(100));

--
-- Index pour la table `ue8vn_workflows`
--
ALTER TABLE `ue8vn_workflows`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `ue8vn_workflow_associations`
--
ALTER TABLE `ue8vn_workflow_associations`
...
--
-- Index pour la table `ue8vn_workflow_stages`
--
ALTER TABLE `ue8vn_workflow_stages`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `ue8vn_workflow_transitions`
--
ALTER TABLE `ue8vn_workflow_transitions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_title` (`title`(191)),
  ADD KEY `idx_asset_id` (`asset_id`),
  ADD KEY `idx_checked_out` (`checked_out`),
...
--
-- AUTO_INCREMENT pour la table `ue8vn_action_logs`
--
ALTER TABLE `ue8vn_action_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `ue8vn_action_logs_extensions`
--
ALTER TABLE `ue8vn_action_logs_extensions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT pour la table `ue8vn_action_log_config`
--
ALTER TABLE `ue8vn_action_log_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT pour la table `ue8vn_assets`
--
ALTER TABLE `ue8vn_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=91;

--
-- AUTO_INCREMENT pour la table `ue8vn_banners`
--
ALTER TABLE `ue8vn_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_banner_clients`
--
ALTER TABLE `ue8vn_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_categories`
--
ALTER TABLE `ue8vn_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `ue8vn_contact_details`
--
ALTER TABLE `ue8vn_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_content`
--
ALTER TABLE `ue8vn_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_content_types`
--
ALTER TABLE `ue8vn_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT pour la table `ue8vn_extensions`
--
ALTER TABLE `ue8vn_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=229;

--
-- AUTO_INCREMENT pour la table `ue8vn_fields`
--
ALTER TABLE `ue8vn_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_fields_groups`
--
ALTER TABLE `ue8vn_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_finder_filters`
--
ALTER TABLE `ue8vn_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_finder_links`
--
ALTER TABLE `ue8vn_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_finder_taxonomy`
--
ALTER TABLE `ue8vn_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `ue8vn_finder_terms`
--
ALTER TABLE `ue8vn_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_finder_types`
--
ALTER TABLE `ue8vn_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_history`
--
ALTER TABLE `ue8vn_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_languages`
--
ALTER TABLE `ue8vn_languages`
  MODIFY `lang_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `ue8vn_menu`
--
ALTER TABLE `ue8vn_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT pour la table `ue8vn_menu_types`
--
ALTER TABLE `ue8vn_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `ue8vn_messages`
--
ALTER TABLE `ue8vn_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_modules`
--
ALTER TABLE `ue8vn_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;

--
-- AUTO_INCREMENT pour la table `ue8vn_newsfeeds`
--
ALTER TABLE `ue8vn_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_overrider`
--
ALTER TABLE `ue8vn_overrider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT pour la table `ue8vn_postinstall_messages`
--
ALTER TABLE `ue8vn_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `ue8vn_privacy_consents`
--
ALTER TABLE `ue8vn_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_privacy_requests`
--
ALTER TABLE `ue8vn_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_redirect_links`
--
ALTER TABLE `ue8vn_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_scheduler_tasks`
--
ALTER TABLE `ue8vn_scheduler_tasks`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_tags`
--
ALTER TABLE `ue8vn_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `ue8vn_template_overrides`
--
ALTER TABLE `ue8vn_template_overrides`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_template_styles`
--
ALTER TABLE `ue8vn_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT pour la table `ue8vn_ucm_content`
--
ALTER TABLE `ue8vn_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_updates`
--
ALTER TABLE `ue8vn_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_update_sites`
--
ALTER TABLE `ue8vn_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `ue8vn_usergroups`
--
ALTER TABLE `ue8vn_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT pour la table `ue8vn_users`
--
ALTER TABLE `ue8vn_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=459;

--
-- AUTO_INCREMENT pour la table `ue8vn_user_keys`
--
ALTER TABLE `ue8vn_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `ue8vn_user_mfa`
--
ALTER TABLE `ue8vn_user_mfa`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_user_notes`
--
ALTER TABLE `ue8vn_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ue8vn_viewlevels`
--
ALTER TABLE `ue8vn_viewlevels`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `ue8vn_workflows`
--
ALTER TABLE `ue8vn_workflows`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `ue8vn_workflow_stages`
--
ALTER TABLE `ue8vn_workflow_stages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `ue8vn_workflow_transitions`
--
ALTER TABLE `ue8vn_workflow_transitions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
('root', '2022-12-29 00:30:26', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"fr\"}');
